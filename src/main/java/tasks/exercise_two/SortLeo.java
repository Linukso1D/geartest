...
/**
 * Complexity is O(log n) per once
 * Complexity is O(n log n), for all
 * */
public class SortLeo
{
    ...
    static <T extends Comparable<? super T>> void smoothSort(T[] source, int startIndex, int endIndex)
    {
